package com.example.mapmo.ende
...
class StorageHandler(context: Context) {
    ...
    fun getEncryptionKey(): String = settings.getString(STORAGE_ENCRYPTION_KEY, "").toString()
    ...
    fun getPassword(): String = settings.getString(STORAGE_PASSWORD, "").toString()
